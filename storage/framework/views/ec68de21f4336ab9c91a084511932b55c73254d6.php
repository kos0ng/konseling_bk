                                    ...
                                    <table class="table table-borderless table-striped table-earning" id="searchtable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                          <button type="button" class="btn btn-success" data-toggle="modal" data-target="#selesai<?php echo e($row->idKonseling); ?>">
            Selesai
        </button>

        <div class="modal fade" id="selesai<?php echo e($row->idKonseling); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false" style="margin-top: 5%">
            <div class="modal-dialog" role="document">
                <form method="post" action="/dashboard/updateHasil">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="id" value="<?php echo e($row->idKonseling); ?>">
                            <label>ID Konseling</label>
                            <div class="form-group">
                                <input type="text" name="nama" class="form-control" disabled="" placeholder="Nama" value="<?php echo e($row->idKonseling); ?>">
                            </div>
...
<?php echo $__env->make('dashboard/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kosong/project/konseling_bk/resources/views/dashboard/jadwal.blade.php ENDPATH**/ ?>