                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Perkembangan {{$all->namaSiswa}}</h3>
                ...
                <form method="post" action="/dashboard/updateNilai">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="id" value="{{$all->idSiswa}}">
                            <label>Nilai Semester 1</label>
                            <div class="form-group">
                                <input type="text" name="nilaiSiswaSmt1" class="form-control" value="{{$all->nilaiSiswaSmt1}}">
                            </div>
                            <label>Nilai Semester 2</label>
                            <div class="form-group">
                                <input type="text" name="nilaiSiswaSmt2" class="form-control" value="{{$all->nilaiSiswaSmt2}}">
                            </div>
                            <label>Nilai Semester 3</label>
                            <div class="form-group">
                                <input type="text" name="nilaiSiswaSmt3" class="form-control" value="{{$all->nilaiSiswaSmt3}}">
                            </div>
                            <label>Nilai Semester 4</label>
                            <div class="form-group">
                                <input type="text" name="nilaiSiswaSmt4" class="form-control" value="{{$all->nilaiSiswaSmt4}}">
                            </div>
                            <label>Nilai Semester 5</label>
                            <div class="form-group">
                                <input type="email" name="nilaiSiswaSmt5" class="form-control" value="{{$all->nilaiSiswaSmt5}}">
                            </div>
                            <label>Nilai Semester 6</label>
                            <div class="form-group">
                                <input type="number" name="nilaiSiswaSmt6" class="form-control" value="{{$all->nilaiSiswaSmt6}}">
                            </div>
                            ...
                            <div class="col-md-4" style="margin-top: 5%">
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Minat {{$all->namaSiswa}}</strong>
                                    </div>
                                    <div class="card-body">
                                        <p class="card-text">
                                            {{$all->minatSiswa}}
                ...
                <form method="post" action="/dashboard/updateMinat">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="id" value="{{$all->idSiswa}}">
                            <label>Minat {{$all->namaSiswa}}</label>
                            <div class="form-group">
