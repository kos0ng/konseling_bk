                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub @yield('siswa')">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="{{route('kasus')}}">Kasus</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub @yield('konseling')">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="{{route('konseling')}}">Selesai</a>
                                </li>
                            </ul>
                        </li>
                        <li class="@yield('walisiswa')">
                            <a href="{{route('walisiswa')}}">
                                <i class="fas fa-user-plus"></i>Data Wali Siswa</a>
                        </li>
                        <li class="@yield('alumni')">
                            <a href="{{route('alumni')}}">
                                <i class="fas fa-mortar-board"></i>Data Alumni</a>
                        </li>
                        <li class="@yield('timbk')">
                            <a href="{{route('timbk')}}">
